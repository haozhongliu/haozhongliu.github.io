...
export const aboutModule = {
  ...
  paragraphs: [
    ...
    "My interests include Human-Computer Interaction (HCI), Human-Agent Collaboration, Multi-Agent Systems, and Visualization. I am particularly interested in how interactive systems can support understanding, design, and creative thinking. I am currently working in the [VAI Group](https://zjuvai.cn/) in [the State Key Lab of CAD&CG](http://fit.zju.edu.cn/fitenglish/2019/0815/c36390a1484193/page.htm) at ZJU, advised by [Prof. Wei Chen](http://www.cad.zju.edu.cn/home/chenwei/) and [Prof. Wei Zhang](https://zwstart.github.io/). I am also open to collaborations and new research opportunities! I expect to graduate in Fall 2028 and plan to continue my research in the United States. Please feel free to reach out if you think there may be a good research fit!",
    "I enjoy traveling, poetry, and music.",
  ...
  socialLinks: [
    ...
    { label: "CV", url: "/pdfs/Haozhong%20Liu%20CV.pdf", iconSrc: "/social-icons/cv.png" },
